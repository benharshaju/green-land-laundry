...
<body>
    <div class="header">
        ...
        <div class="invoice-title">
            ...
            <p>Date: <?php echo e($invoice->issue_date->format('d M Y')); ?></p>
            <?php if($invoice->due_date): ?>
            <p>Due: <?php echo e($invoice->due_date->format('d M Y')); ?></p>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="info-grid">
        <div class="info-box">
            ...
            <?php if($invoice->customer->name_arabic): ?>
            <p><?php echo e($invoice->customer->name_arabic); ?></p>
            <?php endif; ?>
            <p><?php echo e($invoice->customer->phone); ?></p>
            <?php if($invoice->customer->area): ?><p><?php echo e($invoice->customer->area); ?>, Bahrain</p><?php endif; ?>
        </div>
        <div class="info-box">
            <h3>Order Details</h3>
            <p>Order #: <strong><?php echo e($order->order_number); ?></strong></p>
            <p>Currency: <strong>BHD (Bahraini Dinar)</strong></p>
            <p>Payment: <?php echo e($order->payment_method ?? 'Pending'); ?></p>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align:right"><?php echo e(number_format($item->unit_price, 3)); ?></td>
                <td style="text-align:right"><?php echo e(number_format($item->subtotal, 3)); ?></td>
            </tr>
    ...
    <table class="totals">
        <tr>
            <td>Subtotal</td>
            <td>BD <?php echo e(number_format($invoice->subtotal, 3)); ?></td>
        </tr>
        <tr>
            <td>VAT (<?php echo e(number_format($invoice->vat_rate * 100, 0)); ?>%)</td>
            <td>BD <?php echo e(number_format($invoice->vat_amount, 3)); ?></td>
        </tr>
        <tr class="total-row">
            <td>TOTAL DUE</td>
            <td>BD <?php echo e(number_format($invoice->total, 3)); ?></td>
        </tr>
    </table>

    <div class="vat-note">
        <strong>VAT Note:</strong> This invoice includes <?php echo e(number_format($invoice->vat_rate * 100, 0)); ?>% Value Added Tax (VAT)
        in accordance with the Kingdom of Bahrain VAT Law (Law No. 48 of 2018).
        VAT Amount: BD <?php echo e(number_format($invoice->vat_amount, 3)); ?>
...
<?php /**PATH /home/user/green-land-laundry/resources/views/admin/invoices/pdf.blade.php ENDPATH**/ ?>